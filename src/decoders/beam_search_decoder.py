...
from src.decoders.swig_wrapper import Scorer, CTCBeamSearchDecoder
from src.decoders.swig_wrapper import ctc_beam_search_decoding_batch, ctc_beam_search_decoding
...
class BeamSearchDecoder:
    ...
    def decode_batch_beam_search_offline(self, probs_split):
        ...
        beam_search_results = ctc_beam_search_decoding_batch(probs_seq=probs_split,
                                                             vocabulary=self.vocab_list,
                                                             beam_size=self.beam_size,
